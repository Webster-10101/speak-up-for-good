...
export default function SpeakingDrillsPage() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-blue-900">
      ...
      {/* Email Gate wraps the drill cards */}
      <section className="pb-20">
        <div className="container-max section-padding">
          <EmailGate>
            <div className="max-w-4xl mx-auto">
              <div className="bg-blue-500/10 border border-blue-400/20 rounded-lg p-6 mb-12 max-w-4xl mx-auto text-center">
                <p className="text-blue-200 text-lg">
                  Practice these drills regularly to develop muscle memory for confident speaking.
